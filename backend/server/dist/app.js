...
const VerificaToken_1 = require("./auth/VerificaToken");
...
app.get("/notas", VerificaToken_1.VerificaToken, async (req, res) => {
...
app.get("/notas/:notaId", VerificaToken_1.VerificaToken, async (req, res) => {
...
app.get("/produtos", VerificaToken_1.VerificaToken, async (req, res) => {
...
async function criaNota({ afNumber, cidade, produtos }) {
